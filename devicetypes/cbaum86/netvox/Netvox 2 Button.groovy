 ...
 */
metadata {
    definition (name: "Netvox 2-Button Switch", namespace: "chrisb", author: "Chris Baum") {
        capability "Button"
        capability "Configuration"
                
        attribute "button2","ENUM",["released","pressed"]

        fingerprint endpointId: "02", profileId: "0104", manufacturer: "netvox", model: "ZB02BE0ED", deviceJoinName: "Netvox 2-Button Switch", inClusters: "0000, 0001, 0003, 0007", outClusters: "0006"
